...
public class EmployeesController {
    ...
    public DetailedEmployeeDto assignDepartment(@PathVariable Integer empNo, @RequestBody AssignDepartmentToEmployeeCommand cmd) {
        cmd.setEmpNo(empNo);
        gateway.execute(cmd);
        return employeeFinder.getEmployeeDetails(empNo);
    }
    ...
    public DetailedEmployeeDto unassignDepartment(@PathVariable Integer empNo, @RequestBody UnassignDepartmentCommand cmd) {
        cmd.setEmpNo(empNo);
        gateway.execute(cmd);
        return employeeFinder.getEmployeeDetails(empNo);
    ...
    public DetailedEmployeeDto changeEmployeeProfile(@PathVariable Integer empNo, @RequestBody ChangeEmployeeProfileCommand cmd) {
        cmd.setEmpNo(empNo);
        gateway.execute(cmd);
        return employeeFinder.getEmployeeDetails(empNo);
    }
